...
function Footer() {
    return (
        <footer>
            {/* <div> */}
            {/* <p>Retrouvez Jowy sur les réseaux:</p> */}
            <div id="links">
                <a
                    href="mailto:jowystreaming@gmail.com"
                    title="Me contacter"
                    target="_blank"
                ...
                <a
                    href="https://twitter.com/Jowy_TV"
                    title="Twitter"
                    target="_blank"
                    rel="noopener noreferrer"
                >
                ...
                <a
                    href="https://www.twitch.tv/jowytv"
                    title="Twitch"
                    target="_blank"
                    rel="noopener noreferrer"
                >
                ...
                <a
                    href="https://www.youtube.com/channel/UCWTyWYExJ1221Z_HcNBTnSw"
                    title="Youtube"
                    target="_blank"
                    rel="noopener noreferrer"
                >
